...
![Menu Ajouter une source de données]({{ site.url }}/assets/JRS/JRS_fr-08.png)
...
![Propriétés de la source de données]({{ site.url }}/assets/JRS/JRS_fr-09.png)

La dernière étape consiste à choisir un nom pour cette nouvelle source de données, j'ai choisi de l'appeler *Couchbase_DS* :

![Enregistrer la source de données]({{ site.url }}/assets/JRS/JRS_fr-10.png)
