...
![Menu Afficher/Référentiel]({{ site.url }}/img/JRS/JRS_fr-01.png)
...
![Menu Nouveau/Dossier]({{ site.url }}/img/JRS/JRS_fr-02.png)

Saisissons ensuite son nom *WorldDevelopment* :

![Création du dossier du projet]({{ site.url }}/img/JRS/JRS_fr-03.png)
...
![Création du dossier des ressources techniques]({{ site.url }}/img/JRS/JRS_fr-04.png)
...
![Création du dossier des sources de données]({{ site.url }}/img/JRS/JRS_fr-05.png)
...
![Menu contextuel des autorisations]({{ site.url }}/img/JRS/JRS_fr-06.png)

Donnons la permission *Exécuter seulement* au rôle *ROLE_USER* et refermons la boîte de dialogue :

![Permissions sur les ressources techniques]({{ site.url }}/img/JRS/JRS_fr-07.png)
...
![Menu Ajouter une source de données]({{ site.url }}/img/JRS/JRS_fr-08.png)
...
![Propriétés de la source de données]({{ site.url }}/img/JRS/JRS_fr-09.png)

La dernière étape consiste à choisir un nom pour cette nouvelle source de données, j'ai choisi de l'appeler *Couchbase_DS* :

![Enregistrer la source de données]({{ site.url }}/img/JRS/JRS_fr-10.png)
